...
<form class="form-horizontal" role="form" action="{{url('/article/store')}}" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" placeholder="请输入标题" name="a_name" id="a_name">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="radio" name="a_sig" value="1" checked>普通
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="radio" name="a_show" value="1" checked>显示
            <input type="radio" name="a_show" value="2">不显示
        </div>
    </div>
    <div class="form-group">
        <label for="firstname" class="col-sm-2 control-label">文章作者</label>
        <div class="col-sm-8">
            <input type="text" class="form-control" name="a_people" id="a_people">
            <span style="color: red"></span>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="file" class="form-control" id="firstname" name="a_file">
        </div>
    </div>
